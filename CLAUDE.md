...
| `task-routing` | classify delegated work and choose explicit models by subscription headroom and task value; Herdr and OpenRouter/Hermes guidance for Claude Code and Codex orchestrators | existing `agent-usage` |
